...
# Some read only creds so we don't have to generate creds for every new deploy person
# At the moment this pair is associated to ec2inventory user
os.environ['AWS_ACCESS_KEY_ID'] = 'AKIAJRFVRJR6GDTM5VDQ'
os.environ['AWS_SECRET_ACCESS_KEY'] = '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'
