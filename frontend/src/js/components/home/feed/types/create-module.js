...
export default class CreateModuleActivity extends React.Component {
  renderPlan(plan) {
    return (
      <div key={plan.get('id')}>
        <TrainingPlanCard
  ...
  renderOne = act => {
    const plan = act
      .get('object')
      .get('module_training_plan')
      .get('training_plan');
    return (
      <Activity {...this.props} activity={act} activityTxt={t('created_a_lesson')}>
